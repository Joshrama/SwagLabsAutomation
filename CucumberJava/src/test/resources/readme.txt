...
go to login.feature 
right click the scenario then run as cucumber feature
...
Scenario: Purchase the most expensive product
 ...
 saya membuat automationnya untuk menunggu 3000ms karena jika tidak ada delay automationnya tidak berjalan karena terlalu cepat. Lalu untuk verify produk saya menggunakan nama produknya 
